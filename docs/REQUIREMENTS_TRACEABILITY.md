...
| F10 | Offline awareness | The editor shows offline/realtime warnings, keeps a local recovery draft, queues saves, retries failed saves every 5 seconds, and flushes immediately when connectivity returns. |
